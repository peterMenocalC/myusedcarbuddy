...
const Color primaryColor = Color(0xffED5123);
const Color accentColor = Color(0xfff49b4d);
const Color subHeaderBackground = Color(0xffF6B26B);
const Color inspectionHeaderBackground = Color(0xffCCCCCC);



const Color screenBackgroundColor = Color(0xffFFFCFA);
const Color boxColor = Color(0xa38ec545);
