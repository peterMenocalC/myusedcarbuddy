...
class completePage extends StatefulWidget {
  static const String routeName = '/completePage';
  final name;
  final userId;

  completePage({Key key, @required this.name, @required this.userId})
      : super(key: key);
...
class _completePageState extends State<completePage> implements RefreshDataCallback {
  ...
  Future getRequestListData() async {
    ...
    await isNetworkAvailable().then((bool) async {
      if (bool) {
        await fetchRequestListData(widget.userId, "7").then((res) async {
          setState(() {
            mIsLoading = false;
            ...
            Visibility(visible: !isErrorOccured,  child:Padding(
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                        ...
                        hintText: 'Enter data you want to seach',
                ...
                Visibility(
                    ...
                    child: createErrorView(context, "No task completed", this)),
                mIsLoading
                    ? Container(
